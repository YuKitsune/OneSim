namespace OneSim.Map.Tests.Services
{
	using System;
	using System.Linq;
	...
	public class OnlineTrafficServiceTests
	{
												 ...
												 FlightPlan = new FlightPlan
															  {
																  ...
																  EstimatedTimeOfDeparture =
																	  new DateTime(2019,
																				   ...
																				   0,
																				   DateTimeKind.Utc),
																  TimeEnroute = TimeSpan.FromHours(1),
																  FuelOnBoard = TimeSpan.FromHours(1.5),
																  Route = "DCT",
		...
		public async Task DataGetsUpdated()
		{
			...
			Pilot pilotWithPlan = await trafficDbContext.Pilots
														...
														.Include(p => p.History)
														.FirstOrDefaultAsync(p => p.Callsign ==
			...
			// Act
			service = new OnlineTrafficService(provider,
											   parser,
											   trafficDbContext,
											   historicalDbContext,
											   new Mock<ILogger<OnlineTrafficService>>().Object);
