namespace OneSim.Map.Infrastructure
{
	...
	/// <summary>
	/// 	The VATSIM <see cref="IStatusDataProvider"/>
	/// </summary>
	[Network(NetworkType.Vatsim)]
	public class VatsimStatusDataProvider : IStatusDataProvider
	{
		/// <summary>
		...
		/// <summary>
		/// 	Initializes a new instance of the <see cref="VatsimStatusDataProvider"/> class.
		/// </summary>
		/// <param name="settings">
		///		The <see cref="StatusDataProviderSettings"/>.
		/// </param>
		public VatsimStatusDataProvider(StatusDataProviderSettings settings) =>
		...
		/// </param>
		public VatsimStatusDataProvider(IConfiguration configuration)
		{
