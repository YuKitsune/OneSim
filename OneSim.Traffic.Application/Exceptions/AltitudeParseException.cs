// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AltitudeParseException.cs" company="Strato Systems Pty. Ltd.">
//   Copyright (c) Strato Systems Pty. Ltd. All rights reserved.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace OneSim.Traffic.Application.Exceptions
{
    using System;
        ...
        public AltitudeParseException(string altitude, string message = "", Exception innerException = null)
            : base(
                string.IsNullOrEmpty(message) ?
                    $"Unable to parse altitude {(altitude == null ? "null" : $"\"{altitude}\"")}." :
                    message,
                innerException)
            => Altitude = altitude;
    }
