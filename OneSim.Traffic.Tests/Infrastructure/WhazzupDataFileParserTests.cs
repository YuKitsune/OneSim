// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WhazzupDataFileParserTests.cs" company="Strato Systems Pty. Ltd.">
//   Copyright (c) Strato Systems Pty. Ltd. All rights reserved.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace OneSim.Traffic.Tests.Infrastructure
{
    using System;
    ...
    /// <summary>
    ///     The Whazzup Data File Parser Tests.
    /// </summary>
    [TestFixture]
    public class WhazzupDataFileParserTests
    {
        /// <summary>
        ///     Gets a line containing a <see cref="Pilot"/> with a <see cref="FlightPlan"/> in the Whazzup data file
        ///     format.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a line containing a <see cref="Pilot"/> without a <see cref="FlightPlan"/> in the Whazzup data file
        ///     format.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a line containing a <see cref="AirTrafficController"/> in the Whazzup data file format.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a line containing a <see cref="FlightNotification"/> in the Whazzup data file format.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a line containing a <see cref="Server"/> in the Whazzup data file format.
        /// </summary>
        public string ServerLine => "SYD-1:107.191.56.188:Sydney, Australia:SYD-1:1:";

        /// <summary>
        ///     Gets a string representing an example Whazzup data file.
        /// </summary>
...
;   END";
        ...
        {
            // Arrange
            BaseWhazzupDataFileParser parser = new BaseWhazzupDataFileParser();
            Pilot expectedPilot = new Pilot
                                  {
                                      ...
                                      FlightPlan = new FlightPlan
                                                   {
                                                       ...
                                                       DepartureIcao = "WSSS",
                                                       ArrivalIcao = "WMKK",
                                                       ScheduledDepartureTime = new DateTime(
                                                       ...
                                                       EstimatedEnrouteTime = new TimeSpan(0, 37, 0),
                                      ...
                                      Server = "SYD-1",
                                      Squawk = "2000",
                                      LogonTime = DateTime.SpecifyKind(
                                          new DateTime(2019, 12, 26, 04, 09, 30),
                                          DateTimeKind.Utc)
                                  };
            ...
            Assert.AreEqual(expectedPilot.FlightPlan.ScheduledDepartureTime, pilot.FlightPlan.ScheduledDepartureTime);
            ...
            Assert.AreEqual(expectedPilot.FlightPlan.EstimatedEnrouteTime, pilot.FlightPlan.EstimatedEnrouteTime);
            ...
            Assert.AreEqual(expectedPilot.FlightPlan.ScheduledArrivalTime, pilot.FlightPlan.ScheduledArrivalTime);
            ...
            AirTrafficController expectedController = new AirTrafficController
                                                      {
                                                          ...
                                                          Server = "SYD-1",
                                                          LogonTime =
                                                              new DateTime(2019, 12, 26, 04, 28, 58, DateTimeKind.Utc),
                                                          Frequency = "118.300",
        ...
        public void PreFileNoticeLineCanParse()
        {
                                                     ...
                                                     FlightPlan = new FlightPlan
                                                                  {
                                                                      ...
                                                                      EstimatedEnrouteTime = new TimeSpan(1, 47, 0),
            ...
            Assert.AreEqual(expectedPreFile.FlightPlan.ScheduledDepartureTime, flightNotification.FlightPlan.ScheduledDepartureTime);
            ...
            Assert.AreEqual(expectedPreFile.FlightPlan.EstimatedEnrouteTime, flightNotification.FlightPlan.EstimatedEnrouteTime);
            ...
            Assert.AreEqual(expectedPreFile.FlightPlan.ScheduledArrivalTime, flightNotification.FlightPlan.ScheduledArrivalTime);
        }
        ...
        /// <summary>
        ///     Ensures the <see cref="BaseWhazzupDataFileParser"/> can parse all required data from a file.
        /// </summary>
        [Test]
        ...
        /// <summary>
        ///     Ensures the <see cref="BaseWhazzupDataFileParser.ParseFlightPlanAltitude"/> method works given an Altitude.
        /// </summary>
        [Test]
        ...
        /// <summary>
        ///     Ensures the <see cref="BaseWhazzupDataFileParser.ParseFlightPlanAltitude"/> method works given a Flight Level.
        /// </summary>
        [Test]
